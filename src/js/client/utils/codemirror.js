...
(function() {
  CodeMirror.simpleHint = function(editor, getHints, symbol, givenOptions) {
...
(function () {
  ...
  var globals = ("Array Boolean Date Error eval EvalError Float32Array Float64Array Function Infinity Int16Array Int32Array Int8Array isFinite isNaN Iterator JSON Math NaN Number Object parseFloat parseInt RangeError ReferenceError RegExp StopIteration String SyntaxError TypeError Uint16Array Uint32Array Uint8Array Uint8ClampedArray undefined uneval URIError").split(" ");
    ...
    if (context) {
      ...
      if (obj.type == "variable") {
        ...
        if (window.jQuery != null && (obj.string == '$' || obj.string == 'jQuery') &&
          ...
          base = window._();
      } else if (obj.string == "this") {
          options && options.locals && forEach(options.locals, maybeAdd);
      }
      ...
      options && options.globals && forEach(options.globals, maybeAdd);
